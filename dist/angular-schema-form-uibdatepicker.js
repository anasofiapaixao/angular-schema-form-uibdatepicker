...
var parse = __webpack_require__(/*! date-fns/parse */ "./node_modules/date-fns/parse/index.js");

var format = __webpack_require__(/*! date-fns/format */ "./node_modules/date-fns/format/index.js");

var isValid = __webpack_require__(/*! date-fns/is_valid */ "./node_modules/date-fns/is_valid/index.js");
...
angular.module('schemaForm').directive('datepicker', function () {
  return {
    ...
    link: function link(scope, element, attrs, ngModel) {
      var formatString = 'YYYY-MM-DDTHH:mm:ss[Z]';

      var toDate = function toDate(dateString) {
        return dateString ? parse(dateString, formatString) : null;
      };
      ...
      var isValidDateString = function isValidDateString(dateString) {
        return (!dateString || isValid(parse(dateString, formatString))) && isValidDate(toDate(dateString));
